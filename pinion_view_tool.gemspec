...
require 'pinion_view_tool/version'

Gem::Specification.new do |spec|
  spec.name          = "pinion_view_tool"
  spec.version       = PinionViewTool::VERSION
  spec.authors       = ["Stephanie Pinion"]
  spec.email         = ["stephpinion@gmail.com"]
